...
Mixed effect longitudinal models applied to our entire sample showed a significant main effect of sex in the CA1, CA3, CA4, GC-ML-DG, HATA, molecular layer and parasubiculum, where women appeared to show greater decline than men in these subfields. A significant main positive effect of parity was found in the fimbria.
...
fit_cog_domain<-lmer(Z_Language_Composite ~ kids_total*A +age_cog + APOE_binary + education + repro_span + (1 | subject), data_cog_long_composites[data_cog_long_composites$sex == 2,])
...
## Plot all coefficients for women only interaction MEM
