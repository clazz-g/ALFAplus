...
tidy_models_hip_w_int <- map_dfr(models_hip_w_int, ~ {
  ...
  filter(term == "A1"| term == "kids_total" | term == "kids_total:A1")
...
# need to do SEM with GFAP, sTREM, neurogranin
