...
bl = tiers2blacklist(list("HRT", "age_v1", "repro_span", "occupation", "education",
       c("hypertension", "high_chol", "CSF_Neurogranin_V1", "CSF_GFAP_V1", "diabetes", "CSF_IL-6_V1", "vol_Whole_hippocampus_V1", "CSF_A_V1", "Z_PACC_V1", "CSF_sTREM2_V1", "ingreso_hogar", "bmi")))
