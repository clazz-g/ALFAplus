...
emm_int <- emmeans(fit_cog, ~ A | kids_total * time_diff,
                   at = list(kids_total = c(0, 2, 4),
                             time_diff = c(0, 100, 500, 1000, 2000, 2500)),
...
mod_hip<-lmer(vol_parasubiculum ~ kids_total*A*diff_mri +age_v1+ APOE_binary+ scale(TIV)+ (1 | subject), data = hippo_data_long[hippo_data_long$sex==2,])
