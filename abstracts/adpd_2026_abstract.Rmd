...
hippo_data_long%>%
  filter(sex == 2 )%>%
  dplyr::select(-vol_Whole_hippocampal_body, -vol_Whole_hippocampal_head, -vol_Whole_hippocampus, -`vol_hippocampal-fissure`)%>%
run_volume_lmer_regressions( .,c( "kids_total*CSF_NFL" ,"age_mri", "APOE_binary", "scale(TIV)", "(1 | subject)"))
...
#test including men and sex effect

hippo_data_long%>%
  dplyr::select(-vol_Whole_hippocampal_body, -vol_Whole_hippocampal_head, -vol_Whole_hippocampus, -`vol_hippocampal-fissure`)%>%
run_volume_lmer_regressions( .,c( "kids_total*sex*A", "age_mri", "APOE_binary", "scale(TIV)", "(1 | subject)"))
