...
hippo_data_long %>%
  ...
  geom_point(alpha = 0.6, position = position_dodge(width = 1)) +
  geom_boxplot(position = position_dodge(width = 0.9), alpha=.5)+
  facet_wrap(~A) +
  th +
  labs(x = "Number of childbirths", y = "Parasubiculum volume", color = "Number of childbirths", fill= "Number of childbirths")+
